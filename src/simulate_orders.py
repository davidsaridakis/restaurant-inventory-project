...
def main():
    ...
    # --- 3. Table size distribution and simulation ---
    ...
    def simulate_day(covers):
        ...
        all_dishes = (list(small_plates.keys())
            + list(mains.keys())
            + list(desserts.keys())
        )
        dish_counts = {dish: 0 for dish in all_dishes}
